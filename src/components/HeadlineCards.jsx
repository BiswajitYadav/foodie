        ...
        <div className='max-w-[1640px] mx-auto py-12 grid md:grid-cols-3 gap-3 px-4'>
            <div className='rounded-xl relative'>
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                    ...
                    <button className='border-white bg-white text-black mx-2 absolute bottom-4 hover:bg-orange-500 duration-200 hover:border-orange-500 hover:text-white font-semibold'>Order Now</button>
                </div>
